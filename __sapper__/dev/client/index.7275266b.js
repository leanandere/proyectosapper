import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, v as validate_slots, e as element, l as text, r as space, G as svg_element, a as claim_element, b as children, m as claim_text, f as detach_dev, w as claim_space, g as attr_dev, h as add_location, j as insert_dev, n as append_dev, p as noop, F as set_style, y as create_component, E as query_selector_all, z as claim_component, B as mount_component, t as transition_in, k as transition_out, C as destroy_component } from './client.946692b2.js';
...
function create_fragment$2(ctx) {
	...
	const block = {
		c: function create() {
			...
			t7 = space();
			span1 = element("span");
			t8 = text("CHARLIE-PRO@DESIGN.COM");
			t9 = space();
			div3 = element("div");
			nav = element("nav");
			a1 = element("a");
			...
			t21 = space();
			h2 = element("h2");
			t22 = text("Analista de Sistemas.");
			t23 = space();
			div5 = element("div");
			a4 = element("a");
			t24 = text("CONNECT WITH ME / CONTACTAME !");
			this.h();
		},
		l: function claim(nodes) {
			...
			t8 = claim_text(span1_nodes, "CHARLIE-PRO@DESIGN.COM");
			...
			t22 = claim_text(h2_nodes, "Analista de Sistemas.");
			...
			t24 = claim_text(a4_nodes, "CONNECT WITH ME / CONTACTAME !");
		...
		h: function hydrate() {
			...
			add_location(a1, file$1, 34, 16, 2310);
			attr_dev(a2, "href", "#");
			attr_dev(a2, "class", "py-2 px-6 flex hover:text-black");
			add_location(a2, file$1, 37, 16, 2432);
			attr_dev(a3, "href", "#");
			attr_dev(a3, "class", "py-2 px-6 flex hover:text-black");
			add_location(a3, file$1, 40, 16, 2548);
			attr_dev(nav, "class", "font-sen text-gray-800 dark:text-white uppercase text-lg lg:flex items-center hidden");
			add_location(nav, file$1, 33, 12, 2194);
			attr_dev(span2, "class", "w-6 h-1 bg-gray-800 dark:bg-white mb-1");
			add_location(span2, file$1, 45, 16, 2749);
			attr_dev(span3, "class", "w-6 h-1 bg-gray-800 dark:bg-white mb-1");
			add_location(span3, file$1, 47, 16, 2845);
			attr_dev(span4, "class", "w-6 h-1 bg-gray-800 dark:bg-white mb-1");
			add_location(span4, file$1, 49, 16, 2941);
			attr_dev(button, "class", "lg:hidden flex flex-col ml-4");
			add_location(button, file$1, 44, 12, 2686);
			attr_dev(div3, "class", "flex items-center");
			add_location(div3, file$1, 32, 8, 2149);
