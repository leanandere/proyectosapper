import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, v as validate_slots, e as element, r as space, l as text, a as claim_element, b as children, w as claim_space, m as claim_text, f as detach_dev, g as attr_dev, h as add_location, F as set_style, j as insert_dev, n as append_dev, p as noop, y as create_component, E as query_selector_all, z as claim_component, B as mount_component, t as transition_in, k as transition_out, C as destroy_component } from './client.4b261534.js';
...
function create_fragment$2(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(input0, "class", "carousel-open svelte-1b2a8mu");
			...
			add_location(input0, file$1, 49, 2, 1074);
			attr_dev(div0, "class", "block h-full w-full bg-indigo-500 text-white text-5xl text-center");
			add_location(div0, file$1, 51, 3, 1271);
			attr_dev(div1, "class", "carousel-item absolute opacity-0 svelte-1b2a8mu");
			set_style(div1, "height", "50vh");
			add_location(div1, file$1, 50, 2, 1199);
			attr_dev(label0, "for", "carousel-3");
			attr_dev(label0, "class", "prev control-1 w-10 h-10 ml-2 md:ml-10 absolute cursor-pointer hidden text-3xl font-bold text-black hover:text-white rounded-full bg-white hover:bg-blue-700 leading-tight text-center z-10 inset-y-0 left-0 my-auto svelte-1b2a8mu");
			add_location(label0, file$1, 53, 2, 1377);
			attr_dev(label1, "for", "carousel-2");
			attr_dev(label1, "class", "next control-1 w-10 h-10 mr-2 md:mr-10 absolute cursor-pointer hidden text-3xl font-bold text-black hover:text-white rounded-full bg-white hover:bg-blue-700 leading-tight text-center z-10 inset-y-0 right-0 my-auto svelte-1b2a8mu");
			add_location(label1, file$1, 54, 2, 1635);
			attr_dev(input1, "class", "carousel-open svelte-1b2a8mu");
			attr_dev(input1, "type", "radio");
			attr_dev(input1, "id", "carousel-2");
			attr_dev(input1, "name", "carousel");
			attr_dev(input1, "aria-hidden", "true");
			input1.hidden = "";
			add_location(input1, file$1, 57, 2, 1916);
			attr_dev(div2, "class", "block h-full w-full bg-orange-500 text-white text-5xl text-center");
			add_location(div2, file$1, 59, 3, 2095);
			attr_dev(div3, "class", "carousel-item absolute opacity-0 svelte-1b2a8mu");
			set_style(div3, "height", "50vh");
			add_location(div3, file$1, 58, 2, 2023);
			attr_dev(label2, "for", "carousel-1");
			attr_dev(label2, "class", "prev control-2 w-10 h-10 ml-2 md:ml-10 absolute cursor-pointer hidden text-3xl font-bold text-black hover:text-white rounded-full bg-white hover:bg-blue-700 leading-tight text-center z-10 inset-y-0 left-0 my-auto svelte-1b2a8mu");
			add_location(label2, file$1, 61, 2, 2201);
			attr_dev(label3, "for", "carousel-3");
			attr_dev(label3, "class", "next control-2 w-10 h-10 mr-2 md:mr-10 absolute cursor-pointer hidden text-3xl font-bold text-black hover:text-white rounded-full bg-white hover:bg-blue-700 leading-tight text-center z-10 inset-y-0 right-0 my-auto svelte-1b2a8mu");
			add_location(label3, file$1, 62, 2, 2459);
			attr_dev(input2, "class", "carousel-open svelte-1b2a8mu");
			attr_dev(input2, "type", "radio");
			attr_dev(input2, "id", "carousel-3");
			attr_dev(input2, "name", "carousel");
			attr_dev(input2, "aria-hidden", "true");
			input2.hidden = "";
			add_location(input2, file$1, 65, 2, 2741);
			attr_dev(div4, "class", "block h-full w-full bg-green-500 text-white text-5xl text-center");
			add_location(div4, file$1, 67, 3, 2920);
			attr_dev(div5, "class", "carousel-item absolute opacity-0 svelte-1b2a8mu");
			set_style(div5, "height", "50vh");
			add_location(div5, file$1, 66, 2, 2848);
			attr_dev(label4, "for", "carousel-2");
			attr_dev(label4, "class", "prev control-3 w-10 h-10 ml-2 md:ml-10 absolute cursor-pointer hidden text-3xl font-bold text-black hover:text-white rounded-full bg-white hover:bg-blue-700 leading-tight text-center z-10 inset-y-0 left-0 my-auto svelte-1b2a8mu");
			add_location(label4, file$1, 69, 2, 3025);
			attr_dev(label5, "for", "carousel-1");
			attr_dev(label5, "class", "next control-3 w-10 h-10 mr-2 md:mr-10 absolute cursor-pointer hidden text-3xl font-bold text-black hover:text-white rounded-full bg-white hover:bg-blue-700 leading-tight text-center z-10 inset-y-0 right-0 my-auto svelte-1b2a8mu");
			add_location(label5, file$1, 70, 2, 3283);
			attr_dev(label6, "for", "carousel-1");
			attr_dev(label6, "class", "carousel-bullet cursor-pointer block text-4xl text-white hover:text-blue-700 svelte-1b2a8mu");
			add_location(label6, file$1, 75, 4, 3669);
			attr_dev(li0, "class", "inline-block mr-3");
			add_location(li0, file$1, 74, 3, 3633);
			attr_dev(label7, "for", "carousel-2");
			attr_dev(label7, "class", "carousel-bullet cursor-pointer block text-4xl text-white hover:text-blue-700 svelte-1b2a8mu");
			add_location(label7, file$1, 78, 4, 3838);
			attr_dev(li1, "class", "inline-block mr-3");
			add_location(li1, file$1, 77, 3, 3802);
			attr_dev(label8, "for", "carousel-3");
			attr_dev(label8, "class", "carousel-bullet cursor-pointer block text-4xl text-white hover:text-blue-700 svelte-1b2a8mu");
			add_location(label8, file$1, 81, 4, 4007);
			attr_dev(li2, "class", "inline-block mr-3");
			add_location(li2, file$1, 80, 3, 3971);
			attr_dev(ol, "class", "carousel-indicators svelte-1b2a8mu");
			add_location(ol, file$1, 73, 2, 3596);
			attr_dev(div6, "class", "carousel-inner relative overflow-hidden w-full");
			add_location(div6, file$1, 47, 1, 991);
			attr_dev(div7, "class", "carousel relative shadow-2xl bg-white");
			add_location(div7, file$1, 46, 0, 937);
			attr_dev(body, "class", "bg-white font-sans leading-normal tracking-normal");
			add_location(body, file$1, 44, 0, 869);
		},
...
//# sourceMappingURL=data:application/json;charset=utf-8;base64,
