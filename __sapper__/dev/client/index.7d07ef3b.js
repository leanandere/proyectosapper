import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, v as validate_slots, e as element, l as text, r as space, G as svg_element, a as claim_element, b as children, m as claim_text, f as detach_dev, w as claim_space, g as attr_dev, h as add_location, F as set_style, j as insert_dev, n as append_dev, p as noop, y as create_component, E as query_selector_all, z as claim_component, B as mount_component, t as transition_in, k as transition_out, C as destroy_component } from './client.760f8e54.js';
...
function create_fragment$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(path0, file, 28, 28, 2225);
			...
			add_location(svg0, file, 27, 24, 2015);
			attr_dev(li0, "class", "inline-flex items-center block w-full mb-2 ml-5 font-semibold text-left border-solid");
			add_location(li0, file, 26, 20, 1892);
			attr_dev(path1, "stroke-linecap", "round");
			attr_dev(path1, "stroke-linejoin", "round");
			attr_dev(path1, "stroke-width", "2");
			attr_dev(path1, "d", "M5 13l4 4L19 7");
			add_location(path1, file, 34, 28, 2780);
			...
			add_location(svg1, file, 33, 24, 2570);
			attr_dev(li1, "class", "inline-flex items-center block w-full mb-2 ml-5 font-semibold text-left border-solid");
			add_location(li1, file, 32, 20, 2447);
			attr_dev(path2, "stroke-linecap", "round");
			attr_dev(path2, "stroke-linejoin", "round");
			attr_dev(path2, "stroke-width", "2");
			attr_dev(path2, "d", "M5 13l4 4L19 7");
			add_location(path2, file, 40, 28, 3333);
			...
			add_location(svg2, file, 39, 24, 3123);
			attr_dev(li2, "class", "inline-flex items-center block w-full mb-2 ml-5 font-semibold text-left border-solid");
			add_location(li2, file, 38, 20, 3000);
			...
			add_location(button0, file, 45, 16, 3569);
			...
			add_location(path3, file, 68, 28, 5489);
			...
			add_location(svg3, file, 67, 24, 5279);
			attr_dev(li3, "class", "inline-flex items-center block w-full mb-2 ml-5 font-semibold text-left border-solid");
			add_location(li3, file, 66, 20, 5156);
			...
			add_location(path4, file, 74, 28, 6046);
			...
			add_location(svg4, file, 73, 24, 5836);
			attr_dev(li4, "class", "inline-flex items-center block w-full mb-2 ml-5 font-semibold text-left border-solid");
			add_location(li4, file, 72, 20, 5713);
			...
			add_location(path5, file, 80, 28, 6592);
			...
			add_location(svg5, file, 79, 24, 6382);
			attr_dev(li5, "class", "inline-flex items-center block w-full mb-2 ml-5 font-semibold text-left border-solid");
			add_location(li5, file, 78, 20, 6259);
			...
			add_location(path6, file, 86, 28, 7144);
			...
			add_location(svg6, file, 85, 24, 6934);
			attr_dev(li6, "class", "inline-flex items-center block w-full mb-2 ml-5 font-semibold text-left border-solid");
			add_location(li6, file, 84, 20, 6811);
			attr_dev(ul1, "class", "flex-1 p-0 mt-4 leading-7 text-gray-900 border-0 border-gray-200");
			add_location(ul1, file, 65, 16, 5057);
			...
			add_location(button1, file, 91, 16, 7381);
			...
			add_location(div4, file, 50, 12, 4045);
			...
			add_location(path7, file, 114, 28, 9256);
			...
			add_location(svg7, file, 113, 24, 9046);
			attr_dev(li7, "class", "inline-flex items-center block w-full mb-2 ml-5 font-semibold text-left border-solid");
			add_location(li7, file, 112, 20, 8923);
			...
			add_location(path8, file, 120, 28, 9811);
			...
			add_location(svg8, file, 119, 24, 9601);
			attr_dev(li8, "class", "inline-flex items-center block w-full mb-2 ml-5 font-semibold text-left border-solid");
			add_location(li8, file, 118, 20, 9478);
			...
			add_location(path9, file, 126, 28, 10363);
			...
			add_location(svg9, file, 125, 24, 10153);
			attr_dev(li9, "class", "inline-flex items-center block w-full mb-2 ml-5 font-semibold text-left border-solid");
			add_location(li9, file, 124, 20, 10030);
			...
			add_location(path10, file, 132, 28, 10917);
			...
			add_location(svg10, file, 131, 24, 10707);
			attr_dev(li10, "class", "inline-flex items-center block w-full mb-2 ml-5 font-semibold text-left border-solid");
			add_location(li10, file, 130, 20, 10584);
			attr_dev(ul2, "class", "flex-1 p-0 mt-4 leading-7 text-gray-900 border-0 border-gray-200");
			add_location(ul2, file, 111, 16, 8824);
			...
			add_location(button2, file, 137, 16, 11158);
			...
			add_location(div6, file, 96, 12, 7836);
